...
class PolypPVT(nn.Module):
    def __init__(self, backbone_model, channel=32):
        super(PolypPVT, self).__init__()

        self.backbone = backbone_model
        self.Translayer2_0 = BasicConv2d(self.backbone.embed_dims[0], channel, 1)
        self.Translayer2_1 = BasicConv2d(self.backbone.embed_dims[1], channel, 1)
        self.Translayer3_1 = BasicConv2d(self.backbone.embed_dims[2], channel, 1)
        self.Translayer4_1 = BasicConv2d(self.backbone.embed_dims[3], channel, 1)

        self.CFM = CFM(channel)
        self.ca = ChannelAttention(self.backbone.embed_dims[0])
